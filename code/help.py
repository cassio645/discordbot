...
class HelpCog(commands.Cog):
    """
    Uma classe que define comandos de ajuda para o bot.

    Esta classe fornece comandos para exibir informações de ajuda sobre os comandos do bot.
    """

    def __init__(self, bot):
        """
        Inicializa uma instância da classe HelpCog.
    ...
    async def help(self, ctx, argument=None, page=None) -> None:
        """
        ...
        Args:
            ...
            argument (str, opcional): Um argumento opcional que pode especificar um comando específico.
            page (str, opcional): Uma página opcional para navegar nas informações de ajuda.
        ...
        games_embed.set_image(
            url="https://cdn.discordapp.com/attachments/858056671759040522/962683801383890984/connect4.png"
        )
        ...
        initial_help_dialogue.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/979065286705700955/981573706239320074/3_Sem_Ttulo_20220531225244.png"
        )
        initial_help_dialogue.set_image(
            url="https://cdn.discordapp.com/attachments/979065286705700955/981576391822815232/Photo_1654095758656.png"
        )
        ...
        if ctx.channel.id in self.channels:
            if argument is None:
                ...
                argument.lower() == "kivs"
                or argument.lower() == "money"
                or argument.lower() == "apostar"
                or argument.lower() == "diamantes"
            ):
                await ctx.send(embed=kivs_embed)
            elif (
                argument.lower() == "games"
                or argument.lower() == "game"
                or argument.lower() in ["adivinhar", "adv"]
            ):
